...
export default function IndexPage() {
  return (
    <div className="min-h-screen w-full bg-indigo-500">
      ...
      <div className="container max-w-[850px] my-6 md:my-48 flex flex-col items-center">
        <PricingCard />
        <div className="my-24 flex flex-col space-y-4">
          <p className="text-3xl md:text-6xl text-indigo-50 font-black">
            Dog Whisperer AI
          </p>
          <h1 className="text-2xl md:text-6xl text-indigo-50 font-bold">
            World-class dog training for a fraction of the price
          </h1>
          <h2 className="text-lg text-indigo-50">
        ...
        <div className="grid gap-16">
          <div className="grid gap-2">
            ...
            <p className="text-lg text-indigo-50">
              Dog Whisperer is an AI-powered chatbot that is trained to provide
              modern, force-free training advice. You can ask for advice on a
              range of desired behaviors of varying complexities! Our chatbot is
              named Zoe, after the founder&apos;s chihuahua/pitbull puppy!
            </p>
          </div>
          <div className="grid gap-2">
            <h3 className="text-2xl text-white font-bold">
            ...
            <p className="text-lg text-indigo-50">
              ...
              training assistant, and you get to train your dog from the comfort
              of your own home!
            </p>
          </div>
          <div className="grid gap-2">
            ...
            <p className="text-lg text-indigo-50">
              ...
              the future once we&apos;ve built the community a bit more! So stay
              tuned!
            </p>
          </div>
          <div className="grid gap-2">
            ...
            <p className="text-lg text-indigo-50">
              If you run into any behavioral issues or health concerns with your
              pup, please seek professional assistance in your area. Zoe is
              great at training, but she does not replace expert care of trained
              professionals!
            </p>
          </div>
        </div>
